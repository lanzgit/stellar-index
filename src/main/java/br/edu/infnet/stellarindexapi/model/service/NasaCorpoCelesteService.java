...
public class NasaCorpoCelesteService {
  ...
  private List<String> neosConhecidos =
      Arrays.asList(
          "433", // Eros
          "99942", // Apophis
          "1620", // Geographos
  ...
  public CorpoCelesteDTO buscarCorpoCeleste(String designacao) {
    try {
      ...
      throw new RuntimeException(
          "Erro ao consultar API da NASA para: " + designacao + ". Detalhes: " + e.getMessage(), e);
    }
  }
  ...
  public CorpoCeleste buscarCorpoCelesteDetalhado(String designacao) {
    try {
      ...
      log.info(
          "Dados detalhados encontrados para: {} - Nome: {}", designacao, corpoCeleste.getNome());
