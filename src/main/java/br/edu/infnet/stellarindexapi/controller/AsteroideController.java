...
public class AsteroideController {
    ...
    public ResponseEntity<List<AsteroideDTO>> obterTodosOsAsteroides() {
        ...
        List<AsteroideDTO> asteroidesDTO = asteroides.stream()
                .map(AsteroideMapper::toDTO)
    ...
    public ResponseEntity<AsteroideDTO> criarAsteroide(@Valid @RequestBody AsteroideDTO asteroideDTO) {
    ...
    public ResponseEntity<AsteroideDTO> atualizarAsteroide(@PathVariable Integer id, @Valid @RequestBody AsteroideDTO asteroideDTO) {
        Asteroide asteroide = AsteroideMapper.toEntity(asteroideDTO);
